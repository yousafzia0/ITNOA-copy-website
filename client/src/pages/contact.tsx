        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Ready to discuss your IT audit and assurance requirements? Contact our audit professionals today 
              for a comprehensive consultation on governance, risk management, and internal control frameworks.
            </p>
          </div>
        </div>
      </section>
