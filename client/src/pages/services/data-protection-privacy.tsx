        ...
        <section className="py-20 bg-[#01411c] text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact">
                <Button size="lg" variant="secondary" className="bg-white text-[#01411c] hover:bg-white/90 transition-all duration-300">
                  Discuss Privacy Needs
                </Button>
              </Link>
              <Link href="/become-client">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#01411c] transition-all duration-300">
                  Learn More
                </Button>
              </Link>
            </div>
