...
export default function Services() {
  const services = [
    ...
    {
      icon: <Bug className="h-8 w-8 text-[hsl(var(--pakistan-green))]" />,
    ...
    {
      icon: <Tag className="h-8 w-8 text-[hsl(var(--pakistan-green))]" />,
    ...
    {
      icon: <Settings className="h-8 w-8 text-[hsl(var(--pakistan-green))]" />,
    ...
    {
      icon: <CreditCard className="h-8 w-8 text-[hsl(var(--pakistan-green))]" />,
    ...
    {
      icon: <Cloud className="h-8 w-8 text-[hsl(var(--pakistan-green))]" />,
    ...
    {
      icon: <CheckCircle className="h-8 w-8 text-[hsl(var(--pakistan-green))]" />,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            <h1 className="text-4xl lg:text-6xl font-bold text-slate-900 mb-6">
              Our <span className="text-[hsl(var(--pakistan-green))]">Services</span>
            </h1>
              ...
              <Card key={index} className="group border border-slate-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer">
                <Link href={service.href}>
                  <CardContent className="p-8">
                    ...
                    <div className="flex items-center text-[hsl(var(--pakistan-green))] font-semibold group-hover:text-[hsl(var(--pakistan-light))] transition-colors duration-300">
                      Learn More 
