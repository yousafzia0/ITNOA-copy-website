  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: "Workday /HCM Security", path: "/services/workday-hcm-security", description: "Workday module security reviews and SOX-relevant control testing.", icon: <User className="h-5 w-5 text-[#01411c]" /> },
    ...
    },
    {
      ...
      services: [
        ...
        { name: "ISO/IEC 27031 ICT Readiness & Disaster Recovery", path: "/services/iso-27031-ict-readiness-disaster-recovery", description: "Critical activity identification, impact-over-time modeling, dependency mapping, and defensible RTO/RPO targets for recovery planning.", icon: <HardDrive className="h-5 w-5 text-[#01411c]" /> },
